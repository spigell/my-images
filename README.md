...
| `terragrunt-docker/` | Universal workbench | tenv with build-pinned Terraform and Terragrunt, plus cached AWS/Vault providers and on-demand OpenTofu | [explore.ggcr.dev](https://explore.ggcr.dev/?repo=ghcr.io/spigell/tenv-workbench) |
